...
## 2026-06-28 - CLI Help Accessibility vs System Dependencies
**Learning:** Command line tools that execute dependency checks (like ffmpeg/ffprobe) before evaluating argument flags lock out users from accessing basic usage documentation (-h/--help) if they lack the required dependencies, frustrating their experience.
**Action:** Always parse help flags and print documentation first before evaluating system-level requirements or downloading dependencies.
