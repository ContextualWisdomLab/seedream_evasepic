...
## 2026-07-07 - [CLI UX] Help flags before dependency checks
**Learning:** When users ask for help using -h or --help, they should receive the documentation immediately, even if system dependencies like ffmpeg are missing. Failing early on dependency checks blocks users from seeing basic usage instructions.
**Action:** Always parse help flags (-h, --help) at the very beginning of bash scripts, before running any system dependency checks or complex validations.
