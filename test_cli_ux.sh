...
echo "=== Testing ffprobe validation in extract-frames.sh ==="
if ! FFPROBE=/invalid/path/ffprobe bash "$SCRIPT_DIR/extract-frames.sh" "dummy.mp4" "dummy_dir" 2>&1 | grep -q "Error: ffprobe not found."; then
