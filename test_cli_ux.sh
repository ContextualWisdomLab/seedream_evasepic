...
echo "PASS: download-reference.sh prints explicit error message for url"
...
echo "PASS: download-reference.sh prints explicit error message for output_path"
...
echo "PASS: extract-frames.sh prints explicit error message for video_path"
...
echo "PASS: extract-frames.sh prints explicit error message for output_dir"
...
echo "PASS: transcribe.sh prints explicit error message for audio_path"
echo "====================================="
