...
PYTHON_BIN="$(command -v pyenv >/dev/null && pyenv which python3 || command -v python3)"; ln -s -- "$PYTHON_BIN" "$CACHE_HIT_PATH/python3"
ln -s -- "$(command -v env)" "$CACHE_HIT_PATH/env"
ln -s -- "$(command -v bash)" "$CACHE_HIT_PATH/bash"
