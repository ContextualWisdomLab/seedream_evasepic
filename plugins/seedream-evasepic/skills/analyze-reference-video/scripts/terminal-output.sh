...
terminal_safe_text() {
  ...
  # Optimization (Bolt): Unrolled loop into static parameter expansions.
  # In Bash, evaluating 'printf -v' repeatedly inside a loop introduces significant overhead.
  # Hardcoding these replacements avoids loop execution and speeds up string processing.
