...
terminal_safe_text() {
  ...
  value=${value//$'\001'/\\x01}; value=${value//$'\002'/\\x02}; value=${value//$'\003'/\\x03}; value=${value//$'\004'/\\x04}
  value=${value//$'\005'/\\x05}; value=${value//$'\006'/\\x06}; value=${value//$'\007'/\\x07}; value=${value//$'\010'/\\x08}
  value=${value//$'\011'/\\x09}; value=${value//$'\012'/\\x0A}; value=${value//$'\013'/\\x0B}; value=${value//$'\014'/\\x0C}
  value=${value//$'\015'/\\x0D}; value=${value//$'\016'/\\x0E}; value=${value//$'\017'/\\x0F}; value=${value//$'\020'/\\x10}
  value=${value//$'\021'/\\x11}; value=${value//$'\022'/\\x12}; value=${value//$'\023'/\\x13}; value=${value//$'\024'/\\x14}
  value=${value//$'\025'/\\x15}; value=${value//$'\026'/\\x16}; value=${value//$'\027'/\\x17}; value=${value//$'\030'/\\x18}
  value=${value//$'\031'/\\x19}; value=${value//$'\032'/\\x1A}; value=${value//$'\033'/\\x1B}; value=${value//$'\034'/\\x1C}
  value=${value//$'\035'/\\x1D}; value=${value//$'\036'/\\x1E}; value=${value//$'\037'/\\x1F}; value=${value//$'\177'/\\x7F}
  ...
  value=${value//$'\302\200'/\\u0080}; value=${value//$'\302\201'/\\u0081}; value=${value//$'\302\202'/\\u0082}; value=${value//$'\302\203'/\\u0083}
  value=${value//$'\302\204'/\\u0084}; value=${value//$'\302\205'/\\u0085}; value=${value//$'\302\206'/\\u0086}; value=${value//$'\302\207'/\\u0087}
  value=${value//$'\302\210'/\\u0088}; value=${value//$'\302\211'/\\u0089}; value=${value//$'\302\212'/\\u008A}; value=${value//$'\302\213'/\\u008B}
  value=${value//$'\302\214'/\\u008C}; value=${value//$'\302\215'/\\u008D}; value=${value//$'\302\216'/\\u008E}; value=${value//$'\302\217'/\\u008F}
  value=${value//$'\302\220'/\\u0090}; value=${value//$'\302\221'/\\u0091}; value=${value//$'\302\222'/\\u0092}; value=${value//$'\302\223'/\\u0093}
  value=${value//$'\302\224'/\\u0094}; value=${value//$'\302\225'/\\u0095}; value=${value//$'\302\226'/\\u0096}; value=${value//$'\302\227'/\\u0097}
  value=${value//$'\302\230'/\\u0098}; value=${value//$'\302\231'/\\u0099}; value=${value//$'\302\232'/\\u009A}; value=${value//$'\302\233'/\\u009B}
  value=${value//$'\302\234'/\\u009C}; value=${value//$'\302\235'/\\u009D}; value=${value//$'\302\236'/\\u009E}; value=${value//$'\302\237'/\\u009F}
