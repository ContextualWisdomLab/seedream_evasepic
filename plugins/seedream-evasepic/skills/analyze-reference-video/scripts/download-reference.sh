...
if [ "$FILE_SIZE_BYTES" -lt 1024 ]; then
  FILE_SIZE_STR="${FILE_SIZE_BYTES} B"
elif [ "$FILE_SIZE_BYTES" -lt 1048576 ]; then
  FILE_SIZE_STR="$(( (FILE_SIZE_BYTES + 512) / 1024 )) KB"
elif [ "$FILE_SIZE_BYTES" -lt 1073741824 ]; then
  FILE_SIZE_STR="$(( FILE_SIZE_BYTES / 1048576 )).$(( (FILE_SIZE_BYTES % 1048576) * 10 / 1048576 )) MB"
else
  FILE_SIZE_STR="$(( FILE_SIZE_BYTES / 1073741824 )).$(( (FILE_SIZE_BYTES % 1073741824) * 10 / 1073741824 )) GB"
fi
