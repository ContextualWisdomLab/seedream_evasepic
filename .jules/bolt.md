...
## 2026-07-25 - yt-dlp 네트워크 성능 향상
**Learning:** DASH/HLS 스트림 다운로드 시 yt-dlp의 기본 동작은 단일 프래그먼트를 순차적으로 가져오므로 네트워크 I/O 병목이 발생할 수 있습니다.
**Action:** 다운로드 속도를 대폭 개선하려면 `--concurrent-fragments N` (예: 4) 플래그를 추가하여 프래그먼트 가져오기를 병렬화해야 합니다.
