...
## 2026-09-26 - Bash Subshell Optimization
**Learning:** Command substitution subshells (e.g., `var="$(func)"`) incur significant overhead in performance-sensitive Bash scripts.
**Action:** When capturing function output, design functions to accept an output variable name as an argument and assign the result directly using `printf -v <var_name>` to avoid subshell forks and improve execution speed.
