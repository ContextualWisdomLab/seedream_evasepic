...
## 2024-05-13 - Loop Unrolling for Static Replacements
**Learning:** Repeatedly invoking built-ins (like `printf`) inside loops for static text replacements introduces significant overhead in Bash.
**Action:** Unroll these loops into direct, sequential parameter expansions (e.g., `value=${value//pattern/replacement}`) to maximize performance.
