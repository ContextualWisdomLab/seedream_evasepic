...
## 2024-05-18 - [터미널 제어문자 변환 루프 언롤링을 통한 쉘스크립트 성능 최적화]
**Learning:** bash 환경에서 printf builtin을 루프 안에서 수십번 호출하여 문자열 치환 규칙을 생성하는 것은 런타임 오버헤드가 큽니다.
**Action:** 동적으로 규칙을 생성하는 대신, 정적인 치환 규칙(Unrolled strings)을 하드코딩하면 반복 호출을 없애 실행시간을 대폭 단축할 수 있습니다.
