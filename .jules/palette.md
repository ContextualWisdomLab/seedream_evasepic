...
## 2024-05-24 - Readable File Sizes
**Learning:** Raw byte counts for file sizes introduce unnecessary cognitive load for developers and users. Formatting file sizes into human-readable IEC units (KiB, MiB, GiB) significantly improves readability and user experience.
**Action:** When displaying file sizes in CLI tools or scripts, always format them into appropriate human-readable units rather than outputting raw bytes.
