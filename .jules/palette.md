...
## 2025-02-28 - [CLI UX Enhancement] 파일 크기의 가독성 향상
**Learning:** CLI 스크립트에서 파일 크기를 바이트 단위로만 출력하면 사용자가 직관적으로 파일의 크기를 파악하기 어렵다는 점을 배웠습니다.
**Action:** 파일 크기를 계산하여 KB, MB, GB 등의 사람이 읽기 쉬운(human-readable) 형식으로 변환해 출력하도록 수정하여 사용자 경험을 개선합니다.
