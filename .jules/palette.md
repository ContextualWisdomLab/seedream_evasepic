...
## 2024-08-17 - CLI Error Message UX Improvement
**Learning:** Generic error messages like "Missing required argument(s)" are bad for CLI UX because users don't know which specific parameter was omitted.
**Action:** When implementing CLI argument parsing, always validate and report missing required arguments explicitly identifying the missing argument before evaluating or validating optional arguments.
