...
## 2024-09-24 - [터미널 출력 파일 크기 가독성 개선]
**Learning:** 터미널 환경에서 단순 바이트 단위의 파일 크기 출력은 직관적이지 않아 사용자 경험을 저해함.
**Action:** 향후 CLI 스크립트 작성 시에는 파일 크기를 MB나 KB 등 사람이 읽기 쉬운 형식으로 변환하여 출력하도록 함.
