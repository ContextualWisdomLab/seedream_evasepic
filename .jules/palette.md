...
## 2026-09-24 - [CLI UX Enhancement] Human-readable File Sizes
**Learning:** 터미널 출력에서 파일 크기를 바이트(bytes) 단위의 원시 데이터로 노출하면 사용자의 인지 부하가 증가합니다.
**Action:** 파일 크기를 출력할 때는 항상 사용자가 직관적으로 읽기 쉬운 IEC 단위(KiB, MiB, GiB)를 사용하여 인간 친화적으로 제공하도록 합니다.
