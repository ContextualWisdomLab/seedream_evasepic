...
## 2026-09-02 - [CLI UX Enhancement] Human-readable File Size
**Learning:** 터미널 출력에서 바이트(byte) 단위의 큰 숫자는 사용자가 직관적으로 파일 크기를 파악하기 어렵게 만듭니다. (예: 31457280 bytes)
**Action:** 파일 크기를 출력할 때 MB, KB, B와 같이 사람이 읽기 쉬운 형식(human-readable format)으로 변환하여 제공하여 사용자의 인지 부하를 줄여줍니다.
