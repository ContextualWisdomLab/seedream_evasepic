...
## 2026-08-07 - Visual Separation of Download Errors and Recovery Steps
**Learning:** A terminal failure block is easier to scan when diagnostic causes and actionable recovery steps use distinct semantic treatments rather than one undifferentiated warning style.
**Action:** Render download failure causes in red and recovery options in cyan, and protect the contract with a deterministic test that stubs the failing dependency and verifies every colored line.
