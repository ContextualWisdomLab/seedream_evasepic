...
## 2025-02-12 - CLI 용량 표시 UX 개선
**Learning:** CLI 스크립트에서 파일 크기를 바이트 단위로만 표시하면 사용자가 직관적으로 용량을 파악하기 어렵습니다.
**Action:** 스크립트 출력 시 파일 크기를 KB, MB, GB 등의 사람이 읽기 쉬운(human-readable) 형식으로 변환하여 표시하도록 개선해야 합니다.
