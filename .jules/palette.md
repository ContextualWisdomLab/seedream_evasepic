...
## 2024-08-04 - [CLI Help Syntax Highlighting]
**Learning:** Adding ANSI color codes (like Cyan) to concrete `Example:` commands in usage/help blocks makes them stand out visually and clearly indicates they are executable strings, reducing cognitive load.
**Action:** Always apply syntax highlighting to CLI usage examples to improve micro-UX in terminal environments.
