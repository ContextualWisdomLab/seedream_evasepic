...
## 2026-07-16 - [CLI 에러 메시지 UX 개선]
**Learning:** 에러 상태(Red)와 해결 가능한 실행 단계(Cyan)를 시각적으로 분리하면 사용자의 인지 부하가 감소함을 확인함.
**Action:** 향후 CLI 스크립트 작성 시 모든 에러 상황에서 actionable step은 Cyan으로 하이라이트할 것.
