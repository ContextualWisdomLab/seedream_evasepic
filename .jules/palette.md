...
## 2026-08-26 - Display human-readable file sizes in CLI scripts
**Learning:** Outputting raw byte counts for file sizes in terminal scripts can be unreadable and poor UX for users.
**Action:** When displaying file sizes, use tools like awk to calculate and display them in human-readable formats (e.g., KB, MB, GB).
