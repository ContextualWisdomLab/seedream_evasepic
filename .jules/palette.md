...
## 2024-10-23 - Human Readable Size Output
**Learning:** Raw byte counts for file sizes are difficult to interpret. Presenting file sizes in a human-readable format (e.g., KB, MB) significantly improves usability.
**Action:** When a CLI script displays a file size, ensure it parses raw bytes into a human-readable format.
