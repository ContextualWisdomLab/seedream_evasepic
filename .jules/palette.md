...
## 2026-09-21 - [CLI UX] 인간 친화적인 파일 크기 포맷 적용
**Learning:** 터미널 출력에서 바이트(bytes) 단위를 그대로 보여주면, 특히 영상과 같은 큰 파일의 경우 사용자가 크기를 직관적으로 인지하기 매우 어렵습니다. 파일 크기를 KiB, MiB, GiB 단위로 변환하여 출력하면 인지 부하를 줄일 수 있습니다.
**Action:** 스크립트 출력에서 바이트 크기를 1024 기반 단위(KiB, MiB, GiB)로 변환하여 표시하도록 로직을 추가했습니다.
