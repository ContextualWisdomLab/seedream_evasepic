...
## 2025-02-28 - [UX improvement] Human-Readable File Sizes in CLI
**Learning:** 터미널 스크립트에서 파일 크기를 바이트 단위로 출력하면 사용자가 크기를 직관적으로 파악하기 어렵고 인지 부하가 발생함을 확인했습니다.
**Action:** 파일 크기를 출력할 때는 항상 awk 등을 사용하여 B, KB, MB, GB 등의 사람이 읽기 쉬운(Human-Readable) 형식으로 변환하여 제공합니다.
