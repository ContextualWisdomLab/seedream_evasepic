...
## 2024-05-31 - [CLI 에러 상태와 행동 지침의 시각적 분리]
**Learning:** 에러 메시지(빨간색/노란색)와 사용자가 취해야 할 행동 지침을 시각적으로 분리하면 인지 부하를 줄일 수 있습니다.
**Action:** 에러 발생 시 출력되는 해결 방법(Fallback options)에는 CYAN 색상을 사용하여 에러 메시지와 명확히 구분되도록 적용합니다.
