...
## 2024-05-18 - 파일 크기 단위 개선
**Learning:** 다운로드된 파일의 크기를 바이트 단위로만 표시하면 큰 파일의 경우 사용자가 크기를 직관적으로 파악하기 어렵습니다.
**Action:** `awk`를 사용하여 이진 단위(KiB, MiB, GiB)로 변환하여 사람이 읽기 쉬운 형태로 표시하도록 개선합니다.
