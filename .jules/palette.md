...
**Action:** Implemented a human-readable file size formatting logic in `download-reference.sh` to output sizes in MB or KB when appropriate, instead of always outputting raw bytes, resulting in a more user-friendly output.
