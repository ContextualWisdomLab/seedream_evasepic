...
## 2024-07-22 - [CLI UX] 에러 상태와 해결 방법의 시각적 분리
**Learning:** CLI 환경에서 에러 메시지(Red)와 사용자가 취할 수 있는 해결 방법(Cyan)을 시각적으로 명확히 분리하면 인지 부하를 줄이고 문제 해결을 쉽게 유도할 수 있습니다.
**Action:** 스크립트 작성 시 에러 상태는 빨간색으로, 이에 대한 대안이나 조치 방법(예: 우회 방법, 수동 설치 등)은 청록색(Cyan)으로 일관되게 출력하도록 적용합니다.
