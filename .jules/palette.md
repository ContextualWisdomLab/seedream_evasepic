...
## 2026-09-25 - Human-readable CLI file sizes
**Learning:** Outputting raw byte counts for large video files increases cognitive load for users trying to quickly gauge disk usage or quality.
**Action:** Always format large file sizes into human-readable IEC units (KiB, MiB, GiB) in CLI outputs to improve developer UX and reduce friction.
