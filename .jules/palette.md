...
## 2026-09-06 - [CLI UX Enhancement] Human Readable File Sizes
**Learning:** Showing raw bytes for large files (e.g., video files) creates poor UX as users cannot quickly parse the magnitude of the download size.
**Action:** Always format file sizes using human-readable scales (KB, MB, GB) before displaying them in CLI tools.
