...
## 2026-10-24 - [CLI UX Enhancement] Actionable Error Resolution Guidance
**Learning:** Terminal errors that lack explicit, visually distinct (e.g., CYAN) actionable guidance leave users guessing how to resolve failures, increasing cognitive load.
**Action:** Always follow a RED error message with a CYAN actionable suggestion (like "Please provide..." or specific "Fallback options"), physically separating the cause from the fix.
