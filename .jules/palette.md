...
## 2025-02-14 - Syntax Highlight CLI Examples
**Learning:** Users can misinterpret abstract command formats in CLI usage blocks. Providing concrete examples is good, but without visual differentiation, they blend in with standard text.
**Action:** Add Cyan color highlighting to the concrete `Example:` commands in CLI help blocks to make them stand out visually and clearly indicate they are executable strings.
