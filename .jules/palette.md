...
## 2025-02-28 - [CLI UX Enhancement] Human-readable file sizes
**Learning:** 터미널 출력에서 바이트 단위의 거대한 숫자는 사용자가 파일 크기를 직관적으로 인지하는 데 어려움을 줍니다. 큰 숫자를 KB, MB, GB로 변환하여 제공하면 인지 부하가 감소하고 UX가 향상됩니다.
**Action:** 앞으로 사용자에게 파일 크기 등 수치를 제공할 때는 항상 사람이 읽기 쉬운 형식(human-readable format)으로 변환하여 출력하도록 로직을 구현합니다.
