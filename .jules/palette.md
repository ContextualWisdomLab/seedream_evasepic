...
## 2026-07-29 - CLI Error State Separation
**Learning:** Users experience high cognitive load when CLI error messages and fallback options blend together visually, leading to missed resolution steps.
**Action:** Always visually separate error states (Red) from actionable resolution steps (Cyan) in terminal outputs to guide users effectively.
