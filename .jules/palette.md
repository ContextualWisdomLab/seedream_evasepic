...
## 2024-10-24 - 인간이 읽기 쉬운 파일 크기 표시
**Learning:** CLI 도구에서 파일 크기를 원시 바이트(예: 15324561 bytes)로 표시하면 사용자가 즉시 크기를 파악하기 어려워 인지적 부담이 발생합니다.
**Action:** 바이트 단위를 사용자가 쉽게 읽을 수 있는 KiB, MiB, GiB 등의 이진 접두어 단위로 변환하여 출력하도록 개선합니다. 이 때 이식성을 위해 numfmt 대신 POSIX 호환 awk를 사용합니다.
