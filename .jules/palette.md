...
## 2024-08-16 - CLI UX Error Clarity
**Learning:** Generic error messages like 'Missing required argument(s)' force the user to read the entire usage block to figure out what they missed. Targeted error messages clearly indicating exactly which argument is missing (e.g. '<url>' or '<output_path>') significantly reduce cognitive load.
**Action:** Always provide explicit, targeted feedback for required CLI arguments.
