...
## 2026-09-20 - Human Readable File Sizes
**Learning:** Raw byte sizes can cause cognitive load. Base-1024 math with IEC units reduces load.
**Action:** Always format raw byte sizes using human-readable IEC units.
