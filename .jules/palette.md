...
## 2024-05-30 - Clarify CLI Missing Arguments
**Learning:** Generic CLI error messages like "Missing required argument(s)" create confusion. Users benefit significantly when the exact missing parameter is identified.
**Action:** Always validate arguments individually and pinpoint the specific missing parameter (e.g., `<url>`) instead of grouping them together. For optional arguments, validate required parameters first.
